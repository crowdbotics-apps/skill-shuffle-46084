"""
Django settings for skill_shuffle_46084 project.
...
ROOT_URLCONF = 'skill_shuffle_46084.urls'
...
WSGI_APPLICATION = 'skill_shuffle_46084.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "skill_shuffle_46084 API",
    "DESCRIPTION": "API documentation for skill_shuffle_46084 App",
    "VERSION": "v1",
}
